...
export default function LeaveRequestCard({ request, onApprove, onReject, isAdmin, users = [] }) {
  ...
  return (
    <div className="rounded-xl bg-white border border-zinc-100 p-5 hover:shadow-md transition-all duration-200">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-sm text-zinc-600 mb-2">
            ...
            <span className="text-zinc-400">({days} day{days > 1 ? "s" : ""})</span>
          </div>
